...
untar('data/landsat5.tar.gz',exdir='data/LT5')
untar('data/landsat8.tar.gz',exdir='data/LT8')
...
listLT5 <- list.files('data/LT5' ,pattern = glob2rx('*.tif'), full.names = TRUE)
listLT8 <- list.files('data/LT8' ,pattern = glob2rx('*.tif'), full.names = TRUE)
